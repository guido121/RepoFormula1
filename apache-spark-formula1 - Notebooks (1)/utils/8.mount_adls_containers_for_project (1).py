...
def mount_adls(storage_account_name, container_name):
    ...
    if any(moun.mountPoint == f"/mnt/{storage_account_name}/{container_name}" for moun in dbutils.fs.mounts()):
...
mount_adls('sa70903775','raw')

# COMMAND ----------

mount_adls('sa70903775','processed')

# COMMAND ----------

mount_adls('sa70903775','presentation')
